...
namespace TicTacToe
{
	/// <summary>Summary description for CircularList.</summary>
	/// <remarks>Make an ICollection so can turn the whole list into an array.</remarks>
	///<remarks> Make to use index positions.</remarks>
	public class CircularList : IEnumerable //ICollection
	{
		/// <summary></summary>
		private class ListItem 
		{
			...
			public ListItem(object x, ListItem n, ListItem p) : this(x,n) 
			{
				this.Previous = p;
			}
		}
